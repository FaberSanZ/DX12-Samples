...
<img src="Screenshots/IndexBuffer.png" width=380> | [IndexBuffer](Src/IndexBuffer)<br> This example demonstrates how to provide index data to a DXR pipeline using a StructuredBuffer through a Shader Resource View (SRV). The index buffer defines the connectivity of vertices to form triangles and is accessed directly by ray tracing shaders. Combined with the vertex buffer, this enables ray tracing shaders to traverse and intersect geometry without using the rasterization input assembler stage.
